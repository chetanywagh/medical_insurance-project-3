...
st.write(
    """
    This project helps you **predict medical insurance costs instantly** based on your health
...
st.write(
    """
    This project is developed as part of a **Machine Learning & Data Science portfolio**.  
    It demonstrates:  
